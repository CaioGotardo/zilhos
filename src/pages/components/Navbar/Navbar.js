  ...
  return (
    <nav className={styles.navbar}>
      ...
      <div className={styles.banner}>
        ...
        {/* Menu hamburguer */}
        <div id="btnHamburguer" className={styles.menuHamburguer} onClick={() => setMenuOpen(!menuOpen)}>
          <Image src="/menu-hamburguer.png" alt="menu-hamburguer" width={45} height={45} />
        </div>

        {/* Menu lateral */}
        <div id="menuLateral" className={`${styles.menuLateral} ${menuOpen ? styles.aberto : ""}`}>
          <h2>Opções:</h2>
